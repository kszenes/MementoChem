...
(() => {
  var e = (() => {
    "use strict"; return e => {
      const n = e.regex, a = /[\p{XID_Start}_]\p{XID_Continue}*/u, i = ["and", "as", "assert", "async", "await", "break", "case", "class", "continue", "def", "del", "elif", "else", "except", "finally", "for", "from", "global", "if", "import", "in", "is", "lambda", "match", "nonlocal|10", "not", "or", "pass", "raise", "return", "try", "while", "with", "yield", "M", "HF", "RHF", "UHF", "ROHF", "KS", "RKS", "UKS", "ROKS", "CCSD", "MP2", "ccsd_t", "CASSCF", "CASCI", "NEVPT", "kernel", "density_fit", "newton", "make_natorbs", "DFRMP2", "DFUMP2", "run", "stability", "make_rdm1", "stable_opt_internal"], s = {
