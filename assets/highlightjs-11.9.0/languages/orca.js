  ...
  var e = (() => {
    ...
    return e => {
      const n = e.regex,
        ...
        literals = ["HFType", "SCFMode", "STABPerform", "STABRestartUHFifUnstable", "nel", "norb", "mult", "nroots", "TolE", "TolG", "Guess", "TrafoStep", "PTMethod", "CASPT2_ishift", "CASPT2_rshift", "CASPT2_IPEAshift", "ActOrbs", "DoFCI", "NatOrbs"],
